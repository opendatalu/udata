...
DEFAULT_GEOZONES_FILE = (
    "https://s3.eu-central-1.amazonaws.com/download.data.public.lu/tmp/zones.json"
)
DEFAULT_LEVELS_FILE = "https://s3.eu-central-1.amazonaws.com/download.data.public.lu/tmp/levels.json"
