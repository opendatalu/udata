...
def init_app(app: UDataApp):
    if app.config["SENTRY_DSN"]:
        try:
            ...
            # from sentry_sdk.integrations.gevent import GeventIntegration
        ...
        sentry_sdk.init(
            ...
            integrations=[
                ...
                # Add other integrations you need here
            ],
            default_integrations=False,  # Disable default integrations to exclude ThreadingIntegration
