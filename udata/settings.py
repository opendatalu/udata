...
class Defaults(object):
    ...
    TEMPLATE_CACHE_DURATION = 60  # Seconds
    ...
    # Mcaptcha added features
    MCAPTCHA_URL: Optional[str] = None
    MCAPTCHA_BACKEND_URL: Optional[str] = None
    MCAPTCHA_SITE_KEY: Optional[str] = None
    MCAPTCHA_SECRET_KEY: Optional[str] = None

    # Govcert file antivirus scan 
    GOVCERT_AV_API_KEY: Optional[str] = None
